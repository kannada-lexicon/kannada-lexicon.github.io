(function(){
  ...
  var Maps = function(elt){
    ...
    var _sources = {
      nations:'Made with <a target="_blank" href="http://arborjs.org">arbor.js</a>',
    ...
    var _maps = {
      ...
      //europe:{title:"Europe", p:{stiffness:5000}, source:_sources.nations},
      //mideast:{title:"Middle East", p:{stiffness:500}, source:_sources.nations},
      //risk:{title:"Risk", p:{stiffness:400}, source:_sources.risk}
        animals:{title:"animals", p:{stiffness:500}, source:_sources.nations},
        body_parts:{title:"body_parts", p:{stiffness:500}, source:_sources.nations},
        clothing:{title:"clothing", p:{stiffness:500}, source:_sources.nations},
        cooking:{title:"food", p:{stiffness:500}, source:_sources.nations},
        fruits:{title:"fruits", p:{stiffness:500}, source:_sources.nations},
        nature:{title:"nature", p:{stiffness:500}, source:_sources.nations},
        objects:{title:"objects", p:{stiffness:500}, source:_sources.nations},
        profession:{title:"profession", p:{stiffness:500}, source:_sources.nations},
        tools:{title:"tools", p:{stiffness:500}, source:_sources.nations},
        vehicles:{title:"vehicles", p:{stiffness:500}, source:_sources.nations},
        verb:{title:"verb", p:{stiffness:10}, source:_sources.nations},
        noun:{title:"noun", p:{stiffness:10}, source:_sources.nations}
    }
